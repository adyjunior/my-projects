...
<head>
    ...
    <script src="<util:url/>resources/js/application/modules/questionario/question-controller.js"></script>
</head>
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" ng-app="" ng-controller="questionController">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Quest&otilde;es Realizadas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="question in questionsPaginated" class="odd gradeX">
